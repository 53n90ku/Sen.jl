...
function search_exact(vectors::AbstractMatrix,metadata::AbstractVector,query::AbstractVector;k::Int=10,metric::Symbol=:cosine,filter::Union{Nothing,NamedTuple,FilterExpr}=nothing,filter_index::Union{Nothing,BitsetIndex}=nothing,vector_norms::Union{Nothing,AbstractVector}=nothing,excluded::Union{Nothing,BitVector}=nothing,)
