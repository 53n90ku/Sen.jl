...
using Sen: stored_ids,stored_metadata,stored_vectors,strategy_from_symbol,swap_delete_vector!
...
include("test_filter_properties.jl")
include("test_metadata_index_expr.jl")
include("test_expression_exact_ivf.jl")
include("test_expression_filter_aware.jl")
include("test_expression_bound_selectivity.jl")
include("test_expression_planner.jl")
include("test_range_metadata_index.jl")
include("test_range_filter_aware.jl")
include("test_range_properties.jl")
include("test_ivf.jl")
include("test_execution_core.jl")
include("test_storage.jl")
include("test_metadata_store.jl")
include("test_api.jl")
include("test_mutations.jl")
include("test_delta.jl")
include("test_segments.jl")
include("test_concurrency.jl")
include("test_batch_search.jl")
include("test_maintenance.jl")
include("test_database_info.jl")
include("test_public_api.jl")
include("test_planner.jl")
include("test_manifest_store.jl")
include("test_vector_persistence.jl")
include("test_index_persistence.jl")
include("test_metadata_persistence.jl")
include("test_database_persistence.jl")
include("test_wal.jl")
include("test_writer_lock.jl")
include("test_id_store.jl")
